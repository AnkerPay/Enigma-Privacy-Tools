...
const AnkerPrivacyTools = artifacts.require('AnkerPrivacyTools.sol');
...
module.exports = async function(deployer, network, accounts) {
    ...
    deployer.deploy(AnkerPrivacyTools).then(function() {
        console.log(`Smart Contract "AnkerPrivacyTools.Sol" has been deployed at ETH address: ${AnkerPrivacyTools.address}`);
        return;
    });
